...
- Option to make wallpapers transparent
- Option to blur the background behind transparent wallpapers
- Beautiful particles following the cursor
- Smooth scrolling
- Reading deleted messages
- Ghost Mode
- Streamer Mode (Hiding numbers and usernames)

## Important

**MelowGram** is an **unofficial** fork of Telegram Desktop. It is not affiliated with, endorsed by, or sponsored by Telegram Messenger LLP.
...
[preview_image_url]: https://raw.githubusercontent.com/inlokt/MelowGram/blob/dev/docs/assets/preview.png
